...
public class MergeRequestPlugin extends AnalyzerGitLogPlugin {
    public static int nbcommits=0;

    public MergeRequestPlugin(Configuration generalConfiguration) {
    ...
    public void run() {
        if(!configuration.githubOrNormal()){
            if(listCommits==null)
                result = processLog(Parsing.parseLogFromCommand(configuration.getGitPath(),configuration.buildCommand("mergerequest")));
            else
    ...
    static class Result implements AnalyzerPlugin.Result {
        ...
        public String getResultAsHtmlDiv() {
            ...
            try {
                URL url = new URL("https://gaufre.informatique.univ-paris-diderot.fr/api/v4/projects/3327/merge_requests");
